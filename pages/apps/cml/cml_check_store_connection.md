...
summary:
sidebar: cml_sidebar
permalink: /workbook/workbook/apps/cml/check_store_connection.html
folder: workbook
---
...
Примечание: при создании заказов для их позиций существует ограничение на максимальное значение количества товара. Если в интерент магазине создан заказ с количеством >= 9 999 999 999, то загрузка не произойдет, в лог обмена на странице синхронизации будет выведена ошибка.
