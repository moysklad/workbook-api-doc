...
Примечание: для позиций создаваемых заказов существует ограничение на максимальное значение количества товара. Если в интернет магазине создан заказ с количеством >= 9 999 999 999, то загрузка не произойдет, в лог обмена на странице синхронизации будет выведена ошибка.
